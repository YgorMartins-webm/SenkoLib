...
`,
  ...
  <div class="pdp" id="pdp">
      ...
      <article class="section-1">
        ...
        <div class="section-1__content">
          ...
          <ul class="section-1__list" aria-label="Principais atributos do produto">
            <li class="section-1__item"><span class="section-1__marker" aria-hidden="true"></span>Hipoalergênico.</li>
            <li class="section-1__item"><span class="section-1__marker" aria-hidden="true"></span>Perfume delicado.</li>
            <li class="section-1__item"><span class="section-1__marker" aria-hidden="true"></span>Para roupas de bebês.
            </li>
            <li class="section-1__item"><span class="section-1__marker" aria-hidden="true"></span>Até 50 lavagens.</li>
          </ul>
        </div>
      </article>
    </section>
      ...
      <article class="section-3">
        <div class="section-3__content">
          ...
          <ol class="section-3__steps">
            <li class="section-3__step"><span class="section-3__step-number">1</span><span>Máquinas até 8 kg ou lavagem
                à mão: 20 ml.</span></li>
            <li class="section-3__step"><span class="section-3__step-number">2</span><span>Máquinas de 9 a 14 kg: dosar
                22,5 ml.</span></li>
            <li class="section-3__step"><span class="section-3__step-number">3</span><span>Máquinas de 15 kg ou maiores:
                1 tampa.</span></li>
          </ol>
        </div>
      ...
      <article class="section-1 section-1--reverse">
        <div class="section-1__content">
          ...
          <ul class="section-1__list" aria-label="Recomendacoes importantes">
            <li class="section-1__item"><span class="section-1__marker" aria-hidden="true"></span>Não use em seda ou
              couro.</li>
            <li class="section-1__item"><span class="section-1__marker" aria-hidden="true"></span>Não aplique direto na
              roupa.</li>
            <li class="section-1__item"><span class="section-1__marker" aria-hidden="true"></span>Mantenha fora do
              alcance infantil.</li>
            <li class="section-1__item"><span class="section-1__marker" aria-hidden="true"></span>Em contato com olhos,
              lave com água.</li>
          </ul>
        </div>
        <div class="section-1__media">
    ...
    <section class="faq-section" aria-labelledby="faq-section-title">
      <div class="faq-section__header">
        <h3 class="faq-section__title" id="faq-section-title">Dúvidas rápidas</h3>
        <p class="faq-section__subtitle">As principais respostas antes de usar.</p>
      </div>
      <ul class="faq-section__list">
        <li class="faq-section__item">
          <details class="faq-section__item">
            <summary>
              <h3 class="faq-section__q-text">É indicado para roupas de bebê?</h3>
              <span class="faq-section__icon" aria-hidden="true"></span>
            </summary>
            <div class="faq-section__a-inner">
              <p class="faq-section__a-text">Sim, é indicado para roupas de crianças e bebês.</p>
            </div>
          </details>
        </li>
        <li class="faq-section__item">
          <details class="faq-section__item">
            <summary>
              <h3 class="faq-section__q-text">Quantas lavagens o produto rende?</h3>
              <span class="faq-section__icon" aria-hidden="true"></span>
            </summary>
            <div class="faq-section__a-inner">
              <p class="faq-section__a-text">Até 50 lavagens, usando 20 ml em máquinas de até 8 kg.</p>
            </div>
          </details>
        </li>
        <li class="faq-section__item">
          <details class="faq-section__item">
            <summary>
              <h3 class="faq-section__q-text">O amaciante é hipoalergênico?</h3>
              <span class="faq-section__icon" aria-hidden="true"></span>
            </summary>
            <div class="faq-section__a-inner">
              <p class="faq-section__a-text">Sim. Ele é hipoalergênico e dermatologicamente testado.</p>
            </div>
          </details>
        </li>
        <li class="faq-section__item">
          <details class="faq-section__item">
            <summary>
              <h3 class="faq-section__q-text">Onde coloco o amaciante?</h3>
              <span class="faq-section__icon" aria-hidden="true"></span>
            </summary>
            <div class="faq-section__a-inner">
              <p class="faq-section__a-text">No compartimento da máquina ou na água do último enxágue.</p>
            </div>
          </details>
        </li>
        <li class="faq-section__item">
          <details class="faq-section__item">
            <summary>
              <h3 class="faq-section__q-text">Pode usar em qualquer tecido?</h3>
              <span class="faq-section__icon" aria-hidden="true"></span>
            </summary>
            <div class="faq-section__a-inner">
              <p class="faq-section__a-text">Não é recomendado para seda e couro.</p>
            </div>
          </details>
        </li>
      </ul>
