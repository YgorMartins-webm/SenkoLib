        ...
        <article style="width: 100%;" aria-labelledby="product-main-title">
            ...
            <div class="section-15-container">
                <div class="section-15">
                    ...
                    <div class="section-15__image-wrapper">
                        <img class="section-15__image" src="C:\\Users\\maicons\\Downloads\\208364-01.webp"
            ...
            <section class="ll-carousel"
                ...
                <div class="ll-carousel__container">
                    ...
                    <div class="ll-carousel__viewport">
                        ...
                        <div class="ll-carousel__track">
                            ...
                            <article class="ll-carousel__panel ll-carousel__panel--2" id="ll-carousel-panel-2"
                                ...
                                <section class="ll-carousel__layout ll-carousel__layout--media"
                                    ...
                                    <figure class="ll-carousel__figure">
                                        ...
                                        <figcaption class="ll-carousel__caption"
                                            style="--ll-carousel-caption-bg: rgba(0, 0, 0, 0.64); --ll-carousel-caption-text: #ffffff; --ll-carousel-caption-left: 54%;">
                            ...
                            <article class="ll-carousel__panel ll-carousel__panel--3" id="ll-carousel-panel-3"
                                aria-label="Slide 3: Delicadeza em cada detalhe">
                                <section class="ll-carousel__layout ll-carousel__layout--media"
                                    style="--ll-carousel-media-bg: #c82a57; background: #c82a57;"
                                    aria-label="Delicadeza em cada detalhe">
                                    <figure class="ll-carousel__figure">
                                        ...
                                        <figcaption class="ll-carousel__caption"
                                            style="--ll-carousel-caption-bg: rgba(0, 0, 0, 0.64); --ll-carousel-caption-text: #ffffff; --ll-carousel-caption-left: 6%; --ll-carousel-caption-right: auto;">
                                            <h3>Delicadeza em cada detalhe</h3>
                                            <p>A decoração Chá das 5 combina flores e folhas delicadas, inspiradas nos
                                                elementos clássicos da porcelana inglesa.</p>
                                        </figcaption>
                            ...
                            <article class="ll-carousel__panel ll-carousel__panel--4" id="ll-carousel-panel-4"
                                aria-label="Slide 4: Delicadeza em cada detalhe">
                                <section class="ll-carousel__layout ll-carousel__layout--media"
                                    style="--ll-carousel-media-bg: #c82a57; background: #c82a57;"
                                    aria-label="Delicadeza em cada detalhe">
                                    <figure class="ll-carousel__figure">
                    ...
                    <div class="ll-carousel__nav" style="grid-template-columns: repeat(4, minmax(0, 1fr));"
                        ...
                        <label class="ll-carousel__dot ll-carousel__dot--3" for="ll-carousel-slide-3" role="button"
                            ...
                            <span class="ll-carousel__dot-copy">
                                ...
                                <span class="ll-carousel__dot-text">Delicadeza em cada detalhe</span>
                            </span>
