...
/* ═══════════════════════════════════════════════════════════════════════
   ...
   CONFIGURAÇÃO:
     Edite GITHUB_CONFIG abaixo com seu token, owner, repo e branch.
═══════════════════════════════════════════════════════════════════════ */

var GITHUB_CONFIG = {
  TOKEN:  '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',
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (copyGeneratedBtn && !document.getElementById('ghNewLayoutGroup')) {
    ...
    /* Popula imediatamente se o token parecer válido */
    if (GITHUB_CONFIG.TOKEN && GITHUB_CONFIG.TOKEN !== 'ghp_SEU_TOKEN_AQUI') {
