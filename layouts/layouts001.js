...
/*@@@@Senko - sessao-3-card-flip */
  /* variantes: variants/sessao-3-card-flip.js */
  {
    id: 'sessao-3-card-flip',
    name: 'sessão 3 - card flip',
    tags: ['sessão 3', '3', 'card', 'flip', 'card flip', 'resoponsivo', 'acessível'],
    html: `<section class="section-24-2" aria-labelledby="section-24-2-title">
  <header class="section-24-2__header">
    <p class="section-24-2__eyebrow">SESSÃO 24.2</p>
    <h2 class="section-24-2__title" id="section-24-2-title">SUB-TÍTULO</h2>
    <p class="section-24-2__description">
  ...
  <div class="section-24-2__flip">
    <input class="section-24-2__toggle" type="checkbox" id="section-24-2-toggle" aria-describedby="section-24-2-help">

    <div class="section-24-2__card" aria-hidden="true">
      <figure class="section-24-2__side section-24-2__front">
        <picture class="section-24-2__picture">
        ...
        <figcaption class="section-24-2__sr-only">Imagem frontal ilustrativa do produto.</figcaption>
      </figure>

      <figure class="section-24-2__side section-24-2__back">
        <picture class="section-24-2__picture">
        ...
        <figcaption class="section-24-2__back-caption">
          <h3>SUB-TÍTULO</h3>
          <p>Isso é uma descrição. Isso é uma descrição. Isso é uma descrição. Isso é uma descrição.</p>
        </figcaption>
      </figure>
    </div>

    <label class="section-24-2__hitarea" for="section-24-2-toggle">
      <span class="section-24-2__sr-only">Virar cartão para ver a imagem traseira e os detalhes do produto.</span>
    </label>
    <p class="section-24-2__sr-only" id="section-24-2-help">Use o mouse, toque ou pressione espaço quando o controle estiver em foco para virar o cartão.</p>
  </div>
</section>`,
    css: `<style>
.section-24-2,
...
.section-24-2__header {
  max-width: 56rem;
  margin: 0 auto 2rem;
  text-align: center;
}

.section-24-2__eyebrow {
  color: #ff9900;
  font-size: 12px;
  font-weight: 700;
  line-height: 16px;
...
.section-24-2__toggle:checked ~ .section-24-2__card {
  transform: rotateY(180deg);
}

@media (hover: hover) and (pointer: fine) {
  .section-24-2__flip:hover .section-24-2__card {
    transform: rotateY(180deg);
  }
}

.section-24-2__toggle:focus-visible ~ .section-24-2__card {
  outline: 3px solid #ff9900;
  outline-offset: 8px;
  border-radius: 14px;
}

.section-24-2__hitarea {
  position: absolute;
  inset: 0;
  z-index: 20;
  display: block;
...
.section-24-2__picture,
.section-24-2__picture img {
  width: 100%;
  height: 100%;
  display: block;
}
...
.section-24-2__back-caption p {
  font-size: .95rem;
  line-height: 1.45;
  margin: 0;
}

.section-24-2__sr-only {
  position: absolute;
  width: 1px;
  height: 1px;
  padding: 0;
