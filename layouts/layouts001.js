...
SenkoLib.register([
  ...
  <article class="product-header__body">
    ...
    <h1 class="product-header__title">
      TÍTULO DO PRODUTO GAMERESE (Nome, modelo, diferencial...)
    </h1>
  ...
  *{
  ...
  /* variantes: variants/section-2.js */
  {
    ...
    tags: ['Section-2', 'Section 2', '2', 'vídeo', 'header vídeo', 'secso'],
  ...
  * {
  ...
  /*@@@@Senko - section-56 */
  /* variantes: variants/section-56.js */
  {
    id: 'section-56',
    name: 'Section-56',
    tags: ['grande', 'cavalos', 'carlinhos'],
    html: `    <div class="hero-section-49">


      <!-- Imagem para pcGamer -->
      <img class="hero-image-desktop-section-49"
        src="Https://static1.efacil.com.br/wcsstore//AuroraStorefrontAssetStore/PDP/EQUIPE_QUALIDADE_CONTEUDO/section-49-1.png"
        alt="Banner Desktop" width="1600" height="650">

      <!-- Imagem para mobileGamer -->
      <img class="hero-image-mobile-section-49"
        src="Https://static1.efacil.com.br/wcsstore//AuroraStorefrontAssetStore/PDP/EQUIPE_QUALIDADE_CONTEUDO/section-49-2.png"
        alt="Banner Mobile" width="780" height="400">
