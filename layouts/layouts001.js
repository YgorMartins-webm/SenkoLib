...
/*@@@@Senko - section-10 */
  /* variantes: variants/section-10.js */
  {
    id: 'section-10',
    name: 'Section-10',
    tags: ['grid', 'section 10'],
    html: `<section class="section-5" aria-labelledby="section-5-title">
  <div class="section-5-container">

    <header class="section-5__header">
      <span class="section-5__label" aria-hidden="true">Recursos</span>
      <h2 class="section-5__title" id="section-5-title">Tudo que você precisa em um só lugar</h2>
      <p class="section-5__subtitle">Uma plataforma completa para organizar, escalar e entregar com mais eficiência.</p>
    </header>
    ...
    <div class="section-5__grid" role="list">
      ...
      <article class="section-5__block section-5__block--featured" role="listitem">
        ...
        <h3 class="section-5__block-title">Infraestrutura escalável</h3>
        <p class="section-5__block-body">Arquitetura distribuída projetada para crescer junto com o seu produto, sem reconfiguração manual.</p>
        <a class="section-5__block-link" href="#" aria-label="Saiba mais sobre infraestrutura escalável">Saiba mais</a>
      </article>
      ...
      <article class="section-5__block" role="listitem">
        ...
        <h3 class="section-5__block-title">Monitoramento em tempo real</h3>
        <p class="section-5__block-body">Acompanhe métricas, alertas e logs de forma contínua com painéis configuráveis.</p>
        <a class="section-5__block-link" href="#" aria-label="Saiba mais sobre monitoramento">Saiba mais</a>
      </article>
      ...
      <article class="section-5__block" role="listitem">
        ...
        <h3 class="section-5__block-title">Segurança por padrão</h3>
        <p class="section-5__block-body">Criptografia ponta a ponta, controle de acesso granular e conformidade com LGPD e GDPR.</p>
        <a class="section-5__block-link" href="#" aria-label="Saiba mais sobre segurança">Saiba mais</a>
      </article>
      ...
      <article class="section-5__block" role="listitem">
        ...
        <h3 class="section-5__block-title">Análises avançadas</h3>
        <p class="section-5__block-body">Relatórios detalhados e insights automáticos para decisões mais inteligentes e ágeis.</p>
        <a class="section-5__block-link" href="#" aria-label="Saiba mais sobre análises">Saiba mais</a>
      </article>
      ...
      <article class="section-5__block" role="listitem">
        ...
        <h3 class="section-5__block-title">Gestão de equipes</h3>
        <p class="section-5__block-body">Permissões por função, workspaces separados e auditoria de ações em um único painel.</p>
        <a class="section-5__block-link" href="#" aria-label="Saiba mais sobre gestão de equipes">Saiba mais</a>
      </article>
      ...
      <article class="section-5__block" role="listitem">
        ...
        <h3 class="section-5__block-title">API extensível</h3>
        <p class="section-5__block-body">Integre com qualquer ferramenta do seu stack via REST, GraphQL ou webhooks nativos.</p>
        <a class="section-5__block-link" href="#" aria-label="Saiba mais sobre a API">Saiba mais</a>
      </article>
