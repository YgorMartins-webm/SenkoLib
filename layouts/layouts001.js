  ...
  /* variantes: variants/sessao-3-card-flip.js */
  {
    ...
    <div class="section-3__header">
        ...
        <p class="section-3__description">
            Isso é uma descrição. Isso é uma descrição. Isso é uma descrição. Isso é uma descrição. Isso é uma
            descrição. Isso é uma descrição.
        </p>
    </div>
    <div class="section-3__flip">
        <input class="section-3__toggle" type="checkbox" id="section-3-toggle" aria-describedby="section-3-help">
        <div class="section-3__card" aria-hidden="true">
            <figure class="section-3__side section-3__front">
                <picture class="section-3__picture">
                    <source media="(max-width: 430px)"
                        srcset="https://static1.efacil.com.br/wcsstore//AuroraStorefrontAssetStore/PDP/EQUIPE_QUALIDADE_CONTEUDO/imagem1.jpg?ims=320x">
                    <source media="(max-width: 768px)"
                        srcset="https://static1.efacil.com.br/wcsstore//AuroraStorefrontAssetStore/PDP/EQUIPE_QUALIDADE_CONTEUDO/imagem1.jpg?ims=410x">
                    <source media="(min-width: 769px)"
                        srcset="https://static1.efacil.com.br/wcsstore//AuroraStorefrontAssetStore/PDP/EQUIPE_QUALIDADE_CONTEUDO/imagem1.jpg?ims=540x">
                    <img src="https://static1.efacil.com.br/wcsstore//AuroraStorefrontAssetStore/PDP/EQUIPE_QUALIDADE_CONTEUDO/imagem1.jpg"
                        width="410" height="540" loading="eager" decoding="async" alt="">
                </picture>
                <figcaption class="section-3__sr-only">Imagem frontal ilustrativa do produto.</figcaption>
            </figure>

            <figure class="section-3__side section-3__back">
                <picture class="section-3__picture">
                    <source media="(max-width: 430px)"
                        srcset="https://static1.efacil.com.br/wcsstore//AuroraStorefrontAssetStore/PDP/EQUIPE_QUALIDADE_CONTEUDO/imagem2.jpg?ims=320x">
                    <source media="(max-width: 768px)"
                        srcset="https://static1.efacil.com.br/wcsstore//AuroraStorefrontAssetStore/PDP/EQUIPE_QUALIDADE_CONTEUDO/imagem2.jpg?ims=410x">
                    <source media="(min-width: 769px)"
                        srcset="https://static1.efacil.com.br/wcsstore//AuroraStorefrontAssetStore/PDP/EQUIPE_QUALIDADE_CONTEUDO/imagem2.jpg?ims=540x">
                    <img src="https://static1.efacil.com.br/wcsstore//AuroraStorefrontAssetStore/PDP/EQUIPE_QUALIDADE_CONTEUDO/imagem2.jpg"
                        width="410" height="540" loading="lazy" decoding="async" alt="">
                </picture>
        ...
        <label class="section-3__hitarea" for="section-3-toggle">
            <span class="section-3__sr-only">Virar cartão para ver a imagem traseira e os detalhes do produto.</span>
        </label>
        <p class="section-3__sr-only" id="section-3-help">Use o mouse, toque ou pressione espaço quando o controle
            estiver em foco para virar o cartão.</p>
    </div>
</section>`,
    css: `<style>
    .section-3,
    ...
    .section-3__toggle:focus-visible~.section-3__card {
        outline: 3px solid #ff9900;
        outline-offset: 8px;
        border-radius: 14px;
    }
